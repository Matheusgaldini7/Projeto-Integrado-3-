...
class _H15ScreenState extends State<H15Screen> {
  ...
  void _askObjective() => _set(() => _storyText =
      'Guardião: "Você precisa derrotar os chefes espalhados pelo campus.\n\n'
  ...
  void _explore() => _set(() {
        ...
        if (_step == 1) {
          _storyText = 'Você entra em uma sala aleatória do H15.\n\n'
              'As cadeiras estão fora do lugar, o projetor está ligado, mas não há ninguém. Na parede: "Avaliação pendente".';
        } else if (_step == 2) {
          _storyText = 'No corredor, uma lixeira caída. Papéis espalhados com provas.\n\n'
  ...
  void _lose() => _set(() {
        ...
        _bossHp = _bossHpMax; _mode = 'npcIntro'; _step = 0;
        _battle = BattleHelper(bonusAtaque: _player.bonusAtaque);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('H15 — Bloco Infernal', style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
      ...
      Positioned(
        ...
        Padding(
          ...
          child: Column(children: [
            StatusCard(player: _player, bossLabel: 'Maligno',
            ...
            child: EnvironmentCard(
              text: _storyText,
              image: 'assets/backgrounds/h15_img.png',
            ),
          ),

...
class _AuditorioScreenState extends State<AuditorioScreen> {
  ...
  void initState() {
    ...
    _storyText = '${_player.nome} chega ao Grande Auditório — Palco da Aprovação.\n\n'
  ...
  void _startCutscene() => _set(() {
        _storyText = '${_player.nome} caminha pelo corredor central.\n\n'
  ...
  void _continueCutscene() => _set(() {
        _storyText = 'Magnífico levanta uma caneta que brilha em vermelho escuro.\n\n'
  ...
  void _meetRector() => _set(() {
        _storyText = 'Magnífico: "Mais um aluno..."\n\n'
  ...
  void _present() => _set(() {
        _storyText = '${_player.titulo} ${_player.nome}: "Eu não cometi erros. Aqui estão as provas do meu esforço!"\n\n'
  ...
  void _challenge() => _set(() {
        _storyText = '${_player.titulo} ${_player.nome}: "O seu sistema é falho, e eu vim aqui para encerrar esse ciclo."\n\n'
  ...
  void _useSkill() => _set(() {
        ...
        if (_bossHp <= 0) { _mode = 'ending'; _storyText += '\n\nMagnífico: "Então... você realmente concluiu a jornada."'; return; }
        _battle.incrementarTurno();
        final c = _battle.atacarChefe(_bossAtaque);
        _player = _player.copyWith(hp: (_player.hp - c.dano).clamp(0, _player.hpMax));
        _storyText += '\n\n${c.mensagem}';
  ...
  void _receiveFinalReward() {
    ...
    _set(() {
      ...
      _storyText = '🎓 PARABÉNS, ${_player.nome.toUpperCase()}!\n\n'
          ...
          child: Column(children: [
            ...
            Expanded(
              child: EnvironmentCard(
                text: _storyText,
                image: 'assets/backgrounds/auditorio.png',
              ),
            ),

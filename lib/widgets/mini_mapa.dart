  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF0B0F14).withValues(alpha: 0.92),
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        if (_carregando)
            ...
            child: Center(
              child: GestureDetector(
                ...
                child: const Column(mainAxisSize: MainAxisSize.min, children: [
                  Icon(Icons.gps_off, color: Color(0xFFEF4444), size: 24),
                  SizedBox(height: 4),
                  Text('GPS off\nToque p/ tentar',
          ...
          Center(child: _buildRadar(_pos!, destino)),
        ...
        builder: (_, __) => Stack(alignment: Alignment.center, children: [
          ...
          if (dentroRaio)
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFF48D058).withValues(alpha: 0.2),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 1; i <= 3; i++) {
      canvas.drawCircle(center, size.width / 2 * (i / 3),
          Paint()
            ..color = cor.withValues(alpha: 0.07 * i)

...
class BattleActions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final temItens = player.inventario.isNotEmpty;
    ...
    return Column(children: [
      ...
      _btn(
        '🎒 Itens',
        temItens ? const Color(0xFF1A3010) : const Color(0xFF374151),
        temItens ? const Color(0xFF48D058) : const Color(0xFF6B7280),
        temItens ? () => onUsarItem('') : null,
        border: Border.all(
          color: temItens ? const Color(0xFF48D058) : const Color(0xFF374151),
        ),
      ),
